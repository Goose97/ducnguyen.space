...
<div slot="aside" id="sticky-aside" class="sticky mt-12">
  ...
  <div class="mt-4 flex justify-between text-base text-stone-600">
    ...
    <a href="/btree-chronical/optimizations" class="hover:underline underline-offset-4">Part 4 »</a>
  </div>
</div>
...
<ChapterLink text="Continue to Part 4: Optimizations" href="/btree-chronical/optimizations" />
