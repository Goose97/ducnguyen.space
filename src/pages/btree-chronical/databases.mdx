...
<div slot="aside" id="sticky-aside" class="sticky mt-12">
  ...
  <div class="mt-4 flex justify-between text-base text-stone-600">
    <a href="/btree-chronical/basics" class="hover:underline underline-offset-4">« Part 1</a>
    <a href="/btree-chronical/variations" class="hover:underline underline-offset-4">Part 3 »</a>
  </div>
</div>
...
<p>
  ...
  <a href="/btree-chronical/variations#b-link-tree" class="link">Part 4</a>.
</p>

<ChapterLink text="Continue to Part 3: Variations" href="/btree-chronical/variations" />
