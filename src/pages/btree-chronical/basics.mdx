...
<div slot="aside" id="sticky-aside" class="sticky mt-12">
  ...
  <div class="mt-4 flex justify-between text-base text-stone-600">
    <a href="/btree-chronical/intro" class="hover:underline underline-offset-4">« Intro</a>
    <a href="/btree-chronical/databases" class="hover:underline underline-offset-4">Part 2 »</a>
  </div>
</div>
...
<Callout title="B+ Tree">
  ...
  <ul class="list-disc pl-10">
    ...
    <li>B+ Tree stores values only in leaf nodes. Root and internal nodes store
      ...
      <a
        href="/btree-chronical/variations#b-plus-tree"
        rel="noopener noreferrer"
        target="_blank"
        class="link"
      >later</a>.</li>
...
<p>
  ...
  <a
    href="/btree-chronical/optimizations#sibling-pointers"
    rel="noopener noreferrer"
    target="_blank"
...
<ChapterLink text="Continue to Part 2: Databases" href="/btree-chronical/databases" />
